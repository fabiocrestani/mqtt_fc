/*
 * main.c
 * mqtt_fc Raspberry pi cpu temperature producer
...
*********************************************************************\n\
*                                                                   *\n\
* MQTT FC - Raspberry pi cpu temperature                            *\n\
* Author: Fabio Crestani                                            *\n\
* Version: 1.0                                                      *\n\
*                                                                   *\n\
*********************************************************************\n\n");
	...
	// Dummy sensor init
	timer_init(&timer_pi_cpu_temperature, TIMER_PERIOD_1_S * 2, 1);
	timer_start(&timer_pi_cpu_temperature);
	pi_cpu_temperature_set_mqtt_reference(mqtt);
	pi_cpu_temperature_set_mqtt_callback(mqtt_publish_handler_add_data_to_queue);
